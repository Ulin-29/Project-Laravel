    ...
    <header class="bg-white shadow">
        <nav class="container mx-auto px-4 py-6 flex justify-between items-center">
            <div class="flex items-center space-x-4">
                ...
                <img src="assets/img/logo_R.png" alt="Richies Logo" class="w-24">
            </div>
            ...
            <a href="#" class="bg-yellow-400 text-white py-2 px-6 rounded-lg hover:bg-yellow-500">Login</a>
        </nav>
    </header>
    ...
    <section class="container mx-auto px-4 py-12">
        <div class="flex flex-col md:flex-row items-center justify-between">
            ...
            <div class="grid grid-cols-2 gap-4 md:w-1/2">
                <img src="assets/img/rendang.jpg" alt="Rendang" class="w-full h-auto object-cover rounded-lg shadow-lg">
                <img src="assets/img/masakan-indonesia.jpeg" alt="Food Indonesian" class="w-50 h-auto object-cover rounded-lg shadow-lg">
            </div>
